...
struct StatefulTestingHash
    : collie::priv::hash_testing_internal::WithId<
          StatefulTestingHash> 
{
    template <class T>
    size_t operator()(const T& t) const {
        return collie::Hash<T>{}(t);
    }
};
...
namespace std
{
    ...
    // ----------------------------------------------------------------
    template<> 
    struct hash<collie::priv::NonStandardLayout>
    {
        std::size_t operator()(collie::priv::NonStandardLayout const &p) const
        {
